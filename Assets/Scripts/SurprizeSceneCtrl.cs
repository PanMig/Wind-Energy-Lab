...
public class SurprizeSceneCtrl : MonoBehaviour {
    ...
    public void Scenario1()
    {
        ...
        title.text = "Future Scenario 1";
        btnText2.text = "Turn off completely the excess of wind turbines";
        btnText1.text = "Keep the wind farm and sell the excess of power generated by connecting the wind farm with the main electricity grid";
